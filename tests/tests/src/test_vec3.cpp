...
TEST_CASE("Vec3", "")
{
    ...
    SECTION("product()")
    {
        REQUIRE_THAT(Vec3f::product(Vec3f::Zero, Vec3f::OneX), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::product(Vec3f::Zero, Vec3f::OneY), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::product(Vec3f::Zero, Vec3f::OneZ), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::product(Vec3f::OneX, Vec3f::OneY), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::product(Vec3f::OneX, Vec3f::OneZ), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::product(Vec3f::OneY, Vec3f::OneX), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::product(Vec3f::OneY, Vec3f::OneZ), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::product(Vec3f::OneZ, Vec3f::OneX), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::product(Vec3f::OneZ, Vec3f::OneY), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::product(Vec3f(1, 2, 3), Vec3f(4, 5, 6)), Matches::WithinAbs(Vec3f(4, 10, 18)));
    }

    SECTION("min()")
    {
        REQUIRE_THAT(Vec3f::min(Vec3f::Zero, Vec3f::OneX), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::min(Vec3f::Zero, Vec3f::OneY), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::min(Vec3f::Zero, Vec3f::OneZ), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::min(Vec3f::OneX, Vec3f::OneY), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::min(Vec3f::OneX, Vec3f::OneZ), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::min(Vec3f::OneY, Vec3f::OneX), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::min(Vec3f::OneY, Vec3f::OneZ), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::min(Vec3f::OneZ, Vec3f::OneX), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::min(Vec3f::OneZ, Vec3f::OneY), Matches::WithinAbs(Vec3f::Zero));
        REQUIRE_THAT(Vec3f::min(Vec3f(1, 2, 3), Vec3f(4, 5, 6)), Matches::WithinAbs(Vec3f(1, 2, 3)));
    }

    SECTION("max()")
    {
        REQUIRE_THAT(Vec3f::max(Vec3f::Zero, Vec3f::OneX), Matches::WithinAbs(Vec3f::OneX));
        REQUIRE_THAT(Vec3f::max(Vec3f::Zero, Vec3f::OneY), Matches::WithinAbs(Vec3f::OneY));
        REQUIRE_THAT(Vec3f::max(Vec3f::Zero, Vec3f::OneZ), Matches::WithinAbs(Vec3f::OneZ));
        REQUIRE_THAT(Vec3f::max(Vec3f::OneX, Vec3f::OneY), Matches::WithinAbs(Vec3f(1, 1, 0)));
        REQUIRE_THAT(Vec3f::max(Vec3f::OneX, Vec3f::OneZ), Matches::WithinAbs(Vec3f(1, 0, 1)));
        REQUIRE_THAT(Vec3f::max(Vec3f::OneY, Vec3f::OneX), Matches::WithinAbs(Vec3f(1, 1, 0)));
        REQUIRE_THAT(Vec3f::max(Vec3f::OneY, Vec3f::OneZ), Matches::WithinAbs(Vec3f(0, 1, 1)));
        REQUIRE_THAT(Vec3f::max(Vec3f::OneZ, Vec3f::OneX), Matches::WithinAbs(Vec3f(1, 0, 1)));
        REQUIRE_THAT(Vec3f::max(Vec3f::OneZ, Vec3f::OneY), Matches::WithinAbs(Vec3f(0, 1, 1)));
        REQUIRE_THAT(Vec3f::max(Vec3f(1, 2, 3), Vec3f(4, 5, 6)), Matches::WithinAbs(Vec3f(4, 5, 6)));
    }
