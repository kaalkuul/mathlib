...
TEST_CASE("Vec2", "")
{
    ...
    SECTION("Real")
    {
        REQUIRE(sizeof(Vec2f::Real) == sizeof(float));
        REQUIRE(sizeof(Vec2d::Real) == sizeof(double));
    }
    ...
    SECTION("product()")
    {
        REQUIRE_THAT(Vec2f::product(Vec2f::Zero, Vec2f::OneX), Matches::WithinAbs(Vec2f::Zero));
        REQUIRE_THAT(Vec2f::product(Vec2f::Zero, Vec2f::OneY), Matches::WithinAbs(Vec2f::Zero));
        REQUIRE_THAT(Vec2f::product(Vec2f::OneX, Vec2f::OneY), Matches::WithinAbs(Vec2f::Zero));
        REQUIRE_THAT(Vec2f::product(Vec2f(1, 2), Vec2f(3, 4)), Matches::WithinAbs(Vec2f(3, 8)));
    }

    SECTION("min()")
    {
        REQUIRE_THAT(Vec2f::min(Vec2f::Zero, Vec2f::OneX), Matches::WithinAbs(Vec2f::Zero));
        REQUIRE_THAT(Vec2f::min(Vec2f::Zero, Vec2f::OneY), Matches::WithinAbs(Vec2f::Zero));
        REQUIRE_THAT(Vec2f::min(Vec2f::OneX, Vec2f::OneY), Matches::WithinAbs(Vec2f::Zero));
        REQUIRE_THAT(Vec2f::min(Vec2f(1, 2), Vec2f(3, 4)), Matches::WithinAbs(Vec2f(1, 2)));
    }

    SECTION("max()")
    {
        REQUIRE_THAT(Vec2f::max(Vec2f::Zero, Vec2f::OneX), Matches::WithinAbs(Vec2f::OneX));
        REQUIRE_THAT(Vec2f::max(Vec2f::Zero, Vec2f::OneY), Matches::WithinAbs(Vec2f::OneY));
        REQUIRE_THAT(Vec2f::max(Vec2f::OneX, Vec2f::OneY), Matches::WithinAbs(Vec2f(1, 1)));
        REQUIRE_THAT(Vec2f::max(Vec2f(1, 2), Vec2f(3, 4)), Matches::WithinAbs(Vec2f(3, 4)));
    }
