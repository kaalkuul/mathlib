...
template <class Real>
const CAABB3<Real> CAABB3<Real>::One = CAABB3<Real>(
...
template <class Real>
CAABB3<Real>::CAABB3(const Vec3<Real>& _center, const Vec3<Real>& size)
...
template <class Real>
CAABB3<Real>& CAABB3<Real>::set(const Vec3<Real>& point)
{
	center = point;
...
template <class Real>
CAABB3<Real>& CAABB3<Real>::set(const Vec3<Real>& center, const Vec3<Real>& size)
{
	this->center = center;
...
template <class Real>
CAABB3<Real>& CAABB3<Real>::set(const AABB3<Real>& box)
{
...
template <class Real>
CAABB3<Real>& CAABB3<Real>::set(int count, const Vec3<Real>* points)
{
	assert(count > 0);
	...
	return set(AABB3<Real>(inf, sup));
}

template <class Real>
CAABB3<Real>& CAABB3<Real>::set(int count, const Vec3<Real>* points, int stride)
{
	assert(count > 0);
	assert(points != nullptr);
...
template <class Real>
CAABB3<Real>& CAABB3<Real>::add(const Vec3<Real>& point)
{
	...
	return outside ? set(AABB3<Real>(inf, sup)) : *this;
}
...
template <class Real>
CAABB3<Real> CAABB3<Real>::from(const Vec3<Real>& point)
{
	CAABB3<Real> result;
	result.center = point;
...
template <class Real>
CAABB3<Real> CAABB3<Real>::from(const Vec3<Real>& center, const Vec3<Real>& size)
{
	CAABB3<Real> result;
...
template <class Real>
CAABB3<Real> CAABB3<Real>::from(const AABB3<Real>& box)
{
	CAABB3<Real> result;
	result.center = (box.inf + box.sup) * Real(0.5);
	result.extents = (box.sup - box.inf) * Real(0.5);
	return result;
}

template <class Real>
CAABB3<Real> CAABB3<Real>::from(int count, const Vec3<Real>* points)
{
	CAABB3<Real> result;
...
template <class Real>
CAABB3<Real> CAABB3<Real>::from(int count, const Vec3<Real>* points, int stride)
{
	CAABB3<Real> result;
...
template <class Real>
CAABB3<Real>& CAABB3<Real>::operator+= (const Vec3<Real>& t)
{
	center += t;
	return *this;
}
...
template <class Real>
CAABB3<Real>& CAABB3<Real>::operator*= (Real k)
{
	extents *= k;
	return *this;
}
...
template <class Real>
CAABB3<Real> CAABB3<Real>::operator+ (const Vec3<Real>& t) const
{
	CAABB3<Real> result;
...
template <class Real>
CAABB3<Real> CAABB3<Real>::operator* (Real k) const
{
	CAABB3<Real> result;
	result.center = center;
...
template <class Real>
bool CAABB3<Real>::operator==(const CAABB3<Real>& rhs) const
{
...
template <class Real>
Vec3<Real> CAABB3<Real>::inf() const
{
	return center - extents;
}

template <class Real>
Vec3<Real> CAABB3<Real>::sup() const
{
	return center + extents;
}

template <class Real>
Vec3<Real> CAABB3<Real>::size() const
{
	return extents * Real(2);
}

template <class Real>
Sphere<Real> CAABB3<Real>::innerSphere() const
{
	Sphere<Real> result;
	result.center = center;
...
template <class Real>
Sphere<Real> CAABB3<Real>::outerSphere() const
{
	Sphere<Real> result;
	result.center = center;
...
template <class Real>
Real CAABB3<Real>::volume() const
{
	return extents.x * extents.y * extents.z * Real(8);
}

template <class Real>
bool CAABB3<Real>::isNull() const
{
	return extents.isNull();
}

template <class Real>
Vec3<Real> CAABB3<Real>::pointAt(const Vec3<Real>& t) const
{
...
template <class Real>
bool CAABB3<Real>::contains(const Vec3<Real>& point) const
{
...
template <class Real>
bool CAABB3<Real>::contains(const Sphere<Real>& sphere) const
{
...
template <class Real>
bool CAABB3<Real>::contains(const CAABB3<Real>& box) const
{
...
template <class Real>
bool CAABB3<Real>::intersects(const CAABB3<Real>& box) const
{
...
// http://www.codercorner.com/RayCAABB3.cpp

bool CAABB3<Real>::intersects(Vec3<Real>& hit, const Line3<Real>& line) const
{
	bool inside = true;
	Vec3<Real> MaxT;
...
CAABB3<CastReturnType> CAABB3<Real>::cast() const
{
	CAABB3<CastReturnType> result;
